...
KitsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([kit_entity_1.Kit, kit_component_entity_1.KitComponent, product_entity_1.Product]), helpers_module_1.HelpersModule],
