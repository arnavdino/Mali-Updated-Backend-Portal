...
const actions = Object.values(permissions_1.PermissionAction);
const subjects = Object.values(permissions_1.PermissionSubject);
let CaslAbilityFactory = class CaslAbilityFactory {
    createForUser(user) {
        const createAbility = (rules) => (0, ability_1.createMongoAbility)(rules);
